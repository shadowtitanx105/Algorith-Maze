...
function($scope, $interval, $timeout, MazeService) {
    ...
    function renderMarkers() {
        ...
        ctx.fillStyle = '#ffaa00'; ctx.shadowColor = 'rgba(255,170,0,0.5)';
    ...
    function renderPlayer() {
        ...
        ctx.strokeStyle = 'rgba(204,51,255,0.4)'; ctx.lineWidth = 2;
        ctx.shadowColor = 'rgba(204,51,255,0.8)'; ctx.shadowBlur = 16;
        ctx.beginPath(); ctx.arc(x, y, r + 3, 0, Math.PI * 2); ctx.stroke();

        ctx.fillStyle = '#cc33ff'; ctx.shadowBlur = 12;
